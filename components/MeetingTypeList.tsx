...
const MeetingTypeList = () => {
  ...
  return (
    <section className='grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4'>
        ...
        <HomeCard iconLink="/icons/add-meeting.svg" color="bg-orange-1" title="New meeting" description="Start an instant meeting" handleClick={() => setMeetingState("isInstantMeeting")} />
